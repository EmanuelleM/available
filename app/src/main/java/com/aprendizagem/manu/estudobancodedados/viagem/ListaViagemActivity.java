    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ListaViagemActivity.this, ListaGastoActivity.class);
                startActivity(intent);
            }
        });

        // Find the ListView which will be populated with the pet data
        ListView petListView = (ListView) findViewById(R.id.list_view_viagem);
...
//                Uri currentPetUri = ContentUris.withAppendedId(Contract.ViagemEntry.CONTENT_URI, id);
//
