...
public class NovaViagemActivity extends AppCompatActivity implements View.OnClickListener {
     ...
     * the view, and we change the mViagemModificada boolean to true.
     */
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.gender_male))) {
                        mRazao = PetEntry.GENDER_MALE;
                    } else if (selection.equals(getString(R.string.gender_female))) {
                        mRazao = PetEntry.GENDER_FEMALE;
                    } else {
                        mRazao = PetEntry.GENDER_UNKNOWN;
                    }
                }
            }
    ...
    private void savePet() {
        ...
        if (mCurrentViagemUri == null &&
                ...
                TextUtils.isEmpty(weightString) && mRazao == PetEntry.GENDER_UNKNOWN) {
        ...
        values.put(PetEntry.COLUMN_PET_GENDER, mRazao);
        ...
        // Determine if this is a new or existing pet by checking if mCurrentViagemUri is null or not
        if (mCurrentViagemUri == null) {
            ...
            // Otherwise this is an EXISTING pet, so update the pet with content URI: mCurrentViagemUri
            // and pass in the new ContentValues. Pass in null for the selection and selection args
            // because mCurrentViagemUri will already identify the correct row in the database that
            // we want to modify.
    ...
    private void deletePet() {
        ...
        if (mCurrentViagemUri != null) {
            ...
            // Pass in null for the selection and selection args because the mCurrentViagemUri
            // content URI already identifies the pet that we want.
            int rowsDeleted = getContentResolver().delete(mCurrentViagemUri, null, null);
